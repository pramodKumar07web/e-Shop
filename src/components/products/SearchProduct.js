          ...
          {results && results ? (
            <div className={FilterStyle.card_list}>
              {results.map((result) => (
                ...
                <Link to={`/product-details/${result._id}`} key={result._id}>
                   ...
                   <p className={`${FilterStyle.p} ${FilterStyle.p3}`}>
                      Price: $<strike>{result.price}</strike>
                    </p>
                    ...
                    <p className={FilterStyle.p}>
                      Special Price : $
                      {Math.round(
                        result.price * (1 - result.discountPercentage / 100)
                      )}
                    </p>
                    <p className={FilterStyle.p}>Brand : {result.brand}</p>
                    <p className={FilterStyle.p}>
